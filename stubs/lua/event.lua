...
---@overload fun(arg: {event: string, callback: function})
...
---@overload fun(arg: {event: string, callback: function})
---@param event string The name of the event to stop listening for.
...
---@param event string The name of the event to clear callbacks for.
